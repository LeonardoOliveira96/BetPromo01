                ...
                <CardContent className="p-4">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-600">Processadas</p>
                    </div>
                    <div>
                      <p className="text-2xl font-bold text-green-700">
                        {uploadResult.data.newUsers?.toLocaleString() || 0}
                      </p>
                      <p className="text-sm text-green-600">Novos Usuários</p>
                    </div>
                    <div>
                      <p className="text-2xl font-bold text-green-700">
                        {csvUserIds.length.toLocaleString()}
                      </p>
                      <p className="text-sm text-green-600">IDs Carregados</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {/* Data e Hora de Fim */}
                <div className="space-y-4 p-4 border rounded-lg bg-gradient-to-br from-red-50 to-rose-50">
              ...
              {startDate && endDate && new Date(startDate) > new Date() && (
                <div className="p-4 border rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50">
                  <div className="flex items-center space-x-3">
                    <Switch
                      id="scheduleActivation"
                      checked={formData.scheduleActivation}
                      onCheckedChange={(checked) => setFormData({ ...formData, scheduleActivation: checked })}
                    />
                    <div className="space-y-1">
                      <Label htmlFor="scheduleActivation" className="text-blue-800 font-medium">
                        Ativação Automática Agendada
                      </Label>
                      <p className="text-sm text-blue-600">
                        A promoção será ativada automaticamente em {format(new Date(startDate), "PPP 'às'", { locale: ptBR })} {startTime}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="pt-6 border-t">
              ...
              <div className="space-y-4">
                ...
                <Card className="bg-gray-50">
                  <CardContent className="p-4">
                    <h4 className="font-medium mb-3">Resumo da Promoção</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      <div>
                        <span className="text-muted-foreground">Nome:</span>
                        <span className="ml-2 font-medium">{formData.name || 'Não informado'}</span>
                      </div>
                      <div>
                        <span className="text-muted-foreground">Marca:</span>
                        <span className="ml-2 font-medium">{formData.brand || 'Não informado'}</span>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <span className={`ml-2 font-medium ${formData.status ? 'text-green-600' : 'text-orange-600'}`}>
