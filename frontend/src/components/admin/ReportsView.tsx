    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Acompanhe o desempenho das promoções e métricas da plataforma
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Análise detalhada do desempenho de cada promoção
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="text-center py-8 text-muted-foreground">
            <BarChart3 className="h-12 w-12 mx-auto mb-4 opacity-50" />
            <p>Relatórios de desempenho não disponíveis</p>
            <p className="text-sm mt-2">Os dados serão carregados quando a API estiver disponível</p>
          </div>
        </CardContent>
      </Card>
    </div>
